...
parser.add_argument('--alph'  , type=str, default='1.0,0.0,500.0')
...
#         train_loader, val_loader, test_loader = getLoader(args.data, args.batch_size, args.batch_size, augment=False, hasGPU=cf.gpu)
#         return test_loader
#     else:
...
if __name__ == '__main__':
    ...
    logger.info("Number of testing examples: {}".format(len(test_loader.dataset)
))
    logger.info("-------------------------")
